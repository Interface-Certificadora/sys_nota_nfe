    ...
    return (
        ...
        >
            ...
            <Link href="/home" _focus={{ outline: "none" }}>
                <Image w="120px" h="30px" src="/NFEB.svg" alt="Logo" objectFit="cover" />
            </Link>
                    ...
                    <VStack align="start">
                        ...
                        >
                            <Flex align="center" gap={2}>
                                ...
                                <Text fontSize="sm" color="#00713C">Clientes</Text>
                            </Flex>
                            ...
                            >
                                <Link href="/cliente/cadastrar" _focus={{ outline: "none" }}>
                                    <Flex align="center" pl="10" py="4px">
                                        <IconButton aria-label="Cadastrar Clientes" bg="transparent">
                        ...
                        >
                            <Flex align="center" gap={2}>
                                ...
                                <Text fontSize="sm" color="#00713C">Usuários</Text>
                            </Flex>
                            <IconButton aria-label="Expandir" bg="transparent">
                        ...
                        >
                            <Flex align="center" gap={2}>
                                ...
                                <Text fontSize="sm" color="#00713C">Parceiros</Text>
                            </Flex>
                            <IconButton aria-label="Expandir" bg="transparent">
                        ...
                        {openIndex === 3 && (
                            ...
                            >
                                <Link href="/parceiros/cadastrar" _focus={{ outline: "none" }}>
                                    <Flex align="center" pl="10" py="4px">
                                        <IconButton aria-label="Cadastrar Parceiro" bg="transparent">
                                            <FaUserPlus color="#00713C" />
                                        </IconButton>
                                ...
                                <Link href="/parceiros" _focus={{ outline: "none" }}>
                                    <Flex align="center" pl="10" py="4px">
                                        <IconButton aria-label="Lista de Parceiros" bg="transparent">
                                            <FaUser color="#00713C" />
                                        </IconButton>
                        ...
                        {/* Logout */}
                        <Button onClick={handleLogout} w="100%" justifyContent="flex-start" variant="ghost">
                            <IconButton aria-label="Sair" bg="transparent">
                                <FaPowerOff color="red" />
                            </IconButton>
                            <Text fontSize="sm" color="red">Sair</Text>
                        </Button>
                    </VStack>
                </motion.div>
            )}
